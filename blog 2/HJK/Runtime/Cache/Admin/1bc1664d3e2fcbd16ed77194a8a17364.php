...
<div class="main-wrapper">
	...
	<div class="container">
		...
		<div class="user">
			<form action="<?php echo U('Index/editUsers',array('id'=>$_GET['id']));?>" method="get" enctype="multipart/form-data">
				<table>
					<tr class="first">
						<td>登录ID</td>
						<td>用户名</td>
					...
					<tr>
						<td><input type="text" value="" name="user_id"/><?php echo ($user['user_id']); ?></td>
						<td><input type="text" value="" name="name"/><?php echo ($user['name']); ?></td>
						<td><input type="text" value="" name="password"/><?php echo ($user['password']); ?></td>
						<td><a href=""  class="img-bac file file-size">
						<input type="file" name="index_show" id="">更改头像</a></td>
