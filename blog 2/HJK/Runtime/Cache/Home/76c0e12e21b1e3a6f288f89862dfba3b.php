...
<head>
	...
	<link href="/blog 2/Public/asset/global/css/login.css" rel="stylesheet" type="text/css"/>
...
<div class="main-wrapper">
	...
	<div class="login-form">
		...
		<form action="<?php echo U('Index/logins');?>" class="form" method="post">
			<input type="text" name="name" placeholder="用户名">
			<input type="password" name="password" placeholder="密码">
			
			<input type="text"  name="verify" style="width:35%; margin:0 0 20px 100px; float:left;">
			<img onclick="this.src='<?php echo U('Index/verify');?>'+Math.random();" src="<?php echo U('Index/verify');?>" style="margin:0 0 20px 43px; float:left; cursor:pointer;">
